...
Alert._prefix = "ofs_"; // Change this if you have your own solution prefix (as long as the file structure's the same)
...
Alert.showLoading = function (loadingText, width, height, url) {

    loadingText = loadingText || "Please Wait...";
    width = width || 230;
    height = height || 115;

    Alert.show(loadingText, null, [], "LOADING", width, height, url, true);
}
